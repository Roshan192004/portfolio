        ...
        <div className="what-box-in">
          ...
          {config.skills.softSkills && (
            ...
            >
              ...
              <div className="what-corner"></div>
              <div className="what-content-in">
                <h3>{config.skills.softSkills.title}</h3>
                <h4>{config.skills.softSkills.description}</h4>
                <p>
                  {config.skills.softSkills.details}
                </p>
                <h5>Strengths</h5>
                <div className="what-content-flex">
                  {config.skills.softSkills.tools.map((tool, index) => (
                    <div key={index} className="what-tags">{tool}</div>
                  ))}
                </div>
                <div className="what-arrow"></div>
